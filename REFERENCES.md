...
* JAX source preprocessing now includes Stride-like Tukey windowing with configurable time bounds, matching the source-window preparation pattern used in Stride's Devito forward setup.
